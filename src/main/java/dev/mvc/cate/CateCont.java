...
public class CateCont {
  ...
  public ModelAndView create(CateVO cateVO) {
    ...
    ModelAndView mav = new ModelAndView();
    mav.setViewName("/cate/create_msg"); // /webapp/cate/create.jsp
  ...
  public ModelAndView list_all() {
    ModelAndView mav = new ModelAndView();
    mav.setViewName("/cate/list_all"); // /webapp/cate/create.jsp
...
//    ModelAndView mav = new ModelAndView();
//    mav.setViewName("/cate/list"); // /webapp/cate/create.jsp
//    
//    //Categrp 접근
...
//  }
 ...
 public ModelAndView delete(int cateno) {
   ...
   int categrpno = this.cateProc.read(cateno).getCategrpno();
   ...
   mav.setViewName("/cate/delete_msg"); // webapp/cate/update_msg.jsp
//   mav.setViewName("redirect:/cate/list.do?categrpno=" + categrpno);
 ...
 public ModelAndView update_visible(CateVO cateVO) {
   ...
   if (cnt == 1) {
     ...
     mav.setViewName("/cate/update_visible_msg.do"); // request 객체가 전달이 안됨. 
   }

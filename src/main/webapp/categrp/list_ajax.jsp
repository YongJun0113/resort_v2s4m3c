...
<script type="text/javascript">
     ...
     success: function(rdata) { // 서버로부터 성공적으로 응답이 온경우
       if (rdata.cnt > 0) {
         ...
         msg += "<button type='button' onclick='location.reload(true)'>확인</button>";
    	   ...
    	   msg = "『" +$('#name').val()+ "』" + "카테고리 그룹을 등록에 실패했습니다.";
       }
 ...
 function update_form(categrpno) {
   ...
   // var params = 'categrpno=' + ${param.contentsno};
	   ...
	   $.ajax({
	     ...
	     success: function(rdata) { // 서버로부터 성공적으로 응답이 온경우
	       if (rdata.cnt > 0) {
	         ...
	         msg = "『" + $('#name').val()+ "』" + "카테고리 그룹을 수정에 실패했습니다.";
	       }
	       $('#panel1').html(msg); // 메시지 출력
	     },
	     // Ajax 통신 에러, 응답 코드가 200이 아닌경우, dataType이 다른경우 
 ...
 function delete_proc(categrpno){
     // $('#btn_close').attr("data-focus", "이동할 태그 지정");
